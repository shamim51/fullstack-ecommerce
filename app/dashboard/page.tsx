...
import { Breadcrumbs, Button, Calendar, Overlay, Sidebar, SidebarColor, SidebarState, useSidebar } from "@rewind-ui/core";
      ...
      >
        ...
        <Sidebar.Nav>
          ...
          <Sidebar.Nav.Section>
            ...
            <Sidebar.Nav.Section.Item icon={<Briefcase />} label="Add Products" href="/dashboard/add-product" />
            ...
            <Sidebar.Nav.Section.Item icon={<Users />} label="employee" href="#" />
        ...
        <Sidebar.Footer>
          <div className="flex flex-col justify-center items-center text-sm">
            <span className="font-semibold">glitzbd.com</span>
